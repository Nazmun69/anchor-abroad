    ...
    <section className="bg-accent py-20 md:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-accent-foreground/90 mb-8 max-w-2xl mx-auto leading-relaxed">
          Don’t leave your future to chance. Get expert guidance tailored to your situation—and take the first confident step toward living, working, or studying abroad.
        </p>
        ...
        <p className="text-sm text-accent-foreground/80 mt-8">
          Spots fill quickly • Next available consultation: This week
        </p>
      </div>
    </section>
  )
